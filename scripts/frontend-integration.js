 ...
 * This file demonstrates how to integrate Graphindex with a web frontend
 */

// For React/Vue/Angular applications
export class GraphindexClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GraphindexClient(provider, contractAddress);
